...
set output 'iav_co2_rain.ps'

stats 'CO2_RAIN_IAV.dat' using 6:16 name 'rainsh'
stats 'CO2_RAIN_IAV.dat' using 7:17 name 'rainnh'
...
set ytics nomirror
set y2tics nomirror
set y2label "Precipitation (mm/month)"
...
plot ["1982 01":"2017 12"] []\
           ...
           '~/scratch1/enso_results/2556-2592/RAIN_latbnd_iav.dat' using 1:6 axes x1y2 noti w l lt -1 lw 1 lc rgb 'black'
...
plot ["1982 01":"2017 12"] []\
           ...
           '~/scratch1/enso_results/2556-2592/RAIN_latbnd_iav.dat' using 1:7 axes x1y2 noti w l lt -1 lw 1 lc rgb 'black'
